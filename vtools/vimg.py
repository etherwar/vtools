...
class vImg(np.ndarray):
    ...
    def histogram(self,
        ...
        :param      legend : flag parameter for whether or not a legend is shown
        :return            : vHist object
        """
        # TODO: Add config parameter, could be a dict to allow you to customize histogram display
        ...
        # TODO: determine if differentiating defaults based on color space is actually necessary
        ...
        if xlimit is None:
            XLIMIT_DICT = {
                ...
                ('3D', 'HSV'): (0, 256, 0, 256, 0, 256),
                ('3D', 'LAB'): (0, 256, 0, 256, 0, 256),
            }
        ...
        # Convert to grayscale image if all three (3) channels are False and the image is currently colored
            ...
            *chans, final_chan = [self._cDict[e[1]] for e in cczip]
            ...
            if display:
                if len(results) > 1:
                    ...
                    results[0][1].show(title=results[0][2])

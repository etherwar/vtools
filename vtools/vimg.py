...
class vImg(np.ndarray):
    ...
    def __new__(cls, imgFn=None, **kwargs) -> np.ndarray:
        ...
        Parameters:
            ...
            **kwargs (optional, only color kwarg will be processed if img parameter is supplied)
    ...
    def erode(self,  iterations : int = 1, k_size : Tuple[int, int] = (3, 3), k_type : int = cv2.MORPH_RECT):
        ...
        :param Tuple[int, int] k_size : size of the kernel, first is the width, then height in pixels (both must be odd)
    ...
    def slidingWindow(self, step_size = 32, window_size = (64, 64)):
        ...
        :param Tuple[int, int]  window_size :
        :return:
        """
